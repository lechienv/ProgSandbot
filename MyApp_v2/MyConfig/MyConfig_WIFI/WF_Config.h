...
/*--------------------------------------------*/
#define MY_DEFAULT_SSID_NAME                "AndroidAP8576"//"MicrochipGroup2"
...
#define MY_DEFAULT_CHANNEL_LIST             {1,6,11}  //1,6,11          /* Desired channel list              */
...
#define MY_DEFAULT_PSK_PHRASE               "Mecatro2"
